...
var MeetingProvider = function (_a) {
    var _b = _a.logLevel, logLevel = _b === void 0 ? LogLevel.WARN : _b, postLogConfig = _a.postLogConfig, _c = _a.simulcastEnabled, simulcastEnabled = _c === void 0 ? false : _c, _d = _a.enableWebAudio, enableWebAudio = _d === void 0 ? false : _d, logger = _a.logger, videoDownlinkBandwidthPolicy = _a.videoDownlinkBandwidthPolicy, meetingManagerProp = _a.meetingManager, children = _a.children;
...
var VideoInputBackgroundBlurControl = function (_a) {
    ...
    var _g = useState(false), isVideoTransformChecked = _g[0], setIsVideoTransformChecked = _g[1];
    var _h = useState(false), isLoading = _h[0], setIsLoading = _h[1];
    var _j = useState(null), dropdownWithVideoTransformOptions = _j[0], setDropdownWithVideoTransformOptions = _j[1];
    var _k = useState(meetingManager.selectedVideoInputDevice), activeVideoDevice = _k[0], setDevice = _k[1];
    ...
    useEffect(function () {
        ...
        if (isBackgroundBlurSupported) {
            var videoTransformOptions = (React.createElement(PopOverItem, { key: "videoinput", children: React.createElement(React.Fragment, null,
                    isLoading && React.createElement(Spinner, { width: "1.5rem", height: "1.5rem" }),
                    backgroundBlurLabel), checked: isVideoTransformDevice(activeVideoDevice), disabled: isLoading, onClick: function () {
                    setIsLoading(true);
                    setIsVideoTransformChecked(function (current) { return !current; });
                } }));
    ...
    useEffect(function () {
        function onVideoTransformCheckboxChange() {
            var _a, _b, _c, _d;
            return __awaiter(this, void 0, void 0, function () {
                var current;
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        case 0:
                            ...
                            if (!isVideoTransformChecked) return [3 /*break*/, 4];
                        ...
                        case 1:
                            ...
                            return [3 /*break*/, 3];
                        case 2:
                            (_b = meetingManager.logger) === null || _b === void 0 ? void 0 : _b.info('Video Filter is already on.');
                            _e.label = 3;
                        case 3: return [3 /*break*/, 7];
                        case 4:
                            if (!isVideoTransformDevice(activeVideoDevice)) return [3 /*break*/, 6];
                            return [4 /*yield*/, activeVideoDevice.intrinsicDevice()];
                        case 5:
                            current = _e.sent();
                            (_c = meetingManager.logger) === null || _c === void 0 ? void 0 : _c.info('Video filter was turned off - selecting inner device: ' + JSON.stringify(current));
                            return [3 /*break*/, 7];
                        case 6:
                            (_d = meetingManager.logger) === null || _d === void 0 ? void 0 : _d.info('Video Filter is already off.');
                            _e.label = 7;
                        case 7: 
