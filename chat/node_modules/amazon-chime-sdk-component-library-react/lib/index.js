...
var MeetingProvider = function (_a) {
    var _b = _a.logLevel, logLevel = _b === void 0 ? amazonChimeSdkJs.LogLevel.WARN : _b, postLogConfig = _a.postLogConfig, _c = _a.simulcastEnabled, simulcastEnabled = _c === void 0 ? false : _c, _d = _a.enableWebAudio, enableWebAudio = _d === void 0 ? false : _d, logger = _a.logger, videoDownlinkBandwidthPolicy = _a.videoDownlinkBandwidthPolicy, meetingManagerProp = _a.meetingManager, children = _a.children;
...
var VideoInputBackgroundBlurControl = function (_a) {
    ...
    var _g = React.useState(false), isVideoTransformChecked = _g[0], setIsVideoTransformChecked = _g[1];
    var _h = React.useState(false), isLoading = _h[0], setIsLoading = _h[1];
    var _j = React.useState(null), dropdownWithVideoTransformOptions = _j[0], setDropdownWithVideoTransformOptions = _j[1];
    var _k = React.useState(meetingManager.selectedVideoInputDevice), activeVideoDevice = _k[0], setDevice = _k[1];
    ...
    React.useEffect(function () {
        ...
        if (isBackgroundBlurSupported) {
            var videoTransformOptions = (React__default['default'].createElement(PopOverItem, { key: "videoinput", children: React__default['default'].createElement(React__default['default'].Fragment, null,
                    isLoading && React__default['default'].createElement(Spinner, { width: "1.5rem", height: "1.5rem" }),
                    backgroundBlurLabel), checked: amazonChimeSdkJs.isVideoTransformDevice(activeVideoDevice), disabled: isLoading, onClick: function () {
                    setIsLoading(true);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 4:
                            if (!amazonChimeSdkJs.isVideoTransformDevice(activeVideoDevice)) return [3 /*break*/, 6];
